...
module.exports = {
    ...
    temperature: async (endpoint, overrides) => {
        const p = payload('measuredValue', repInterval.MINUTES_5, repInterval.HOUR, 100, overrides);
    ...
    illuminance: async (endpoint, overrides) => {
        const p = payload('measuredValue', repInterval.MINUTES_5, repInterval.HOUR, 500, overrides);
